          ...
          <ol className="list-decimal pl-5 space-y-4 text-[#3A2E17] text-lg md:text-xl leading-relaxed">
            <li>
              ...
              <span className="text-green-600 font-semibold">
                (1 produk memiliki 5 pertanyaan acak)
              </span>
            </li>
            <li>
              Ketika sudah memilih, produk tanaman akan tersedia pada{" "}
              <span className="text-green-600 font-semibold">piring</span> dan
              diberikan{" "}
              <span className="text-green-600 font-semibold">
                pertanyaan di sebelahnya
              </span>{" "}
            </li>
            <li>
              Pengguna menjawab pertanyaan. Jika jawaban benar, akan{" "}
              <span className="text-green-600 font-semibold">
                diberikan 5 poin
              </span>{" "}
              dan jika salah{" "}
